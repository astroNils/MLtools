...
def build_optimizer_sgd(cfg: CfgNode, model: torch.nn.Module) -> torch.optim.Optimizer:
    """
...
def build_optimizer_adam(cfg: CfgNode, model: torch.nn.Module) -> torch.optim.Optimizer:
    """
    Build an optimizer from config.
    """
    params = get_default_optimizer_params(
